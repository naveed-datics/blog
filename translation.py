...
def get_conversational_chain():
    ...
    Create a comprehensive information about 3000 words on this {question} also includes every element of his biography {question} from data given to you make me comprehensive article finish content gap and merge all data in 1 article SEO-optimized article in HTML Tags for WordPress

    Write Content in this order:
    1.	Open with: 'Learn the heartbreaking truth about [focus keyword]. Explore the rumors and facts surrounding [focus keyword].'
    2.	Give me answers in list with label 
        Name:
        Death Reason:
        Profession:
        Age:        
    ...
    3.	Write as Stephen, an expert reporter with 15 years of experience in Entertainment and History News and have the authority to write this article in the introduction including expert opinion as well. The article should be in a human-written way more natural, conversational tone,User Engagement,Interactive,Expand High-Altitude Tips,User-Generated Content,Accessibility,Update Studies and References, and flow aimed at better engaging and relating to readers.
    4.	{question} (600 words). 
    5.	{question} Parents (250 words).  heading render in h2
    6.	Early Life 
    7.	Education and Career Beginnings
    8.	Rise to Career
    9.	Collaborations
    10.	Personal Life and Relationships heading render in h2 and avoid tag display in text
    11.	Net Worth and Career Success
    12. Influence and Legacy
    13.	Include if news about Attending Religious Events.   
    17. Related Queries and their answers and Queries render in H3
    18. Longtail keywords and their answers and keywords render in H3 and avoid tag display in text
    19. Conclusion heading render in h2 and avoid tag display in text
    20. FAQs heading render in h2 (10 with answers and Questions render in H3 and avoid tag display in text)
    21.	If you’re interested in learning more about other celebrities, feel free to visit my website: 'https://howdidcelebdie.com/'>https://howdidcelebdie.com/.
    ...
    0.  Format the output in HTML Tags for WordPress.
